...
RUN wget -O /tmp/android-ndk-r27c-linux.zip https://dl.google.com/android/repository/android-ndk-r27c-linux.zip
...
COPY --from=build-android-armv7 /s/binaries /s/binaries
COPY --from=build-android-arm64 /s/binaries /s/binaries
$(DOCKERFILE_CHECKSUM)
endef
